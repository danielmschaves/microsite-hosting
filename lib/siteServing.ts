...
// ---------------------------------------------------------------------------
// The actual "serve a site's live content" logic, shared by the path-based
// route (app/s/[slug]/[[...path]]/route.ts) and the host-based route
// (app/mbhost/[[...path]]/route.ts, CD-20) — same bytes out regardless of
// which URL shape got you here. Extracted here (PRD v2.0 CD-20) so the two
// callers can never drift: session gate, canViewSite, deployment_serving
